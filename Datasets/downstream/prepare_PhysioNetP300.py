...
all_chans = ['Fp1', 'AF7', 'AF3', 'F1', 'F3', 'F5', 'F7', 'FT7', 'FC5', 'FC3', 'FC1', 'C1', 'C3', 'C5', 'T7', 'TP7',
...
for sub in [1, 2, 3, 4, 5, 6, 7, 9, 11]:
    ...
    for file in os.listdir(path):
        ...
        epochs = mne.Epochs(raw, events, event_id=event_id, tmin=tmin, tmax=tmax, event_repeated='drop', preload=True,
                            proj=False)  # ,event_repeated='drop',reject_by_annotation=True)
