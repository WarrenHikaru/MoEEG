...
class LitEEGPTCausal(pl.LightningModule):
    ...
    def __init__(self):
        ...
        self.feature        = model
        self.head   =   LinearWithConstraint(22200, 4, max_norm=1)#
...
if __name__ == "__main__":
    ...
    for seed in [7,718,1029]:
        ...
        for test_sub in all_subjects:
            ...
            logger = [
                pl_loggers.TensorBoardLogger(f'./logs/LaBraM/Seed{seed}', name="LOSO_BCIC2a_tb", version=f"test_sub{test_sub}"),
                pl_loggers.CSVLogger(f'./logs/LaBraM/Seed{seed}', name="LOSO_BCIC2a_csv", version=f"test_sub{test_sub}")
        ]
