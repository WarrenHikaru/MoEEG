...
if __name__ == "__main__":
    ...
    for seed in [7,718,1029]:
        ...
        for test_sub in all_subjects:
            ...
            logger = [
                pl_loggers.TensorBoardLogger(f'./logs/BIOT/Seed{seed}', name="LOSO_BCIC2b_tb", version=f"test_sub{test_sub}"),
                pl_loggers.CSVLogger(f'./logs/BIOT/Seed{seed}', name="LOSO_BCIC2b_csv", version=f"test_sub{test_sub}")
        ]
