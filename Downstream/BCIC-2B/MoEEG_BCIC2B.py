...
if __name__ == "__main__":
    ...
    for test_sub in all_subjects:
        ...
        logger = [
            pl_loggers.TensorBoardLogger('./logs/MoEEG/', name="LOSO_BCIC2b_tb", version=f"test_sub{test_sub}"),
            pl_loggers.CSVLogger('./logs/MoEEG/', name="LOSO_BCIC2b_csv", version=f"test_sub{test_sub}")
        ]
