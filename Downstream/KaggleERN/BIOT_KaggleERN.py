...
for seed in [7,718,1029]:
    ...
    # init model
        ...
        trainer = pl.Trainer(accelerator='cuda',
                ...
                logger=[pl_loggers.TensorBoardLogger(f'./logs/BIOT/Seed{seed}', name="BIOT_ERN_tb", version=f"fold{k}_model{pretrain_model_choice}"),
                        pl_loggers.CSVLogger(f'./logs/BIOT/Seed{seed}', name="BIOT_ERN_csv")])
