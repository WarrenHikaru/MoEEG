...
for seed in [7,718,1029]:
    ...
    for k,v in Folds.items():
        ...
        trainer = pl.Trainer(accelerator='cuda',
                ...
                logger=[pl_loggers.TensorBoardLogger(f'./logs/EEGPT/Seed{seed}/', name="EEGPT_ERN_tb", version=f"fold{k}"),
                        pl_loggers.CSVLogger(f'./logs/EEGPT/Seed{seed}/', name="EEGPT_ERN_csv")])
