...
class LitEEGPTCausal(pl.LightningModule):
    ...
    def __init__(self, load_path="../../checkpoint/MoEEG_large.ckpt"):
        ...
        self.linear_probe2   =   LinearWithConstraint(128, 2, max_norm=0.25)
    ...
    def on_validation_epoch_end(self) -> None:
        ...
        for key, value in results.items():
            if key == "balanced_accuracy":
                print(f" Balance Accuracy: {value}")
...
for k,v in Folds.items():
    ...
    trainer = pl.Trainer(accelerator='cuda',
                ...
                logger=[pl_loggers.TensorBoardLogger('./logs/', name="MoEEG_V06_tb", version=f"Fold{k}"),
                        pl_loggers.CSVLogger('./logs/', name="MoEEG_V06_csv",version=f"Fold{k}")])
