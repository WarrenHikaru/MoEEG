    ...
    for seed in [7,718,1029]:
        ...
        for i, sub in enumerate(all_subjects):
            ...
            trainer = pl.Trainer(accelerator='cuda',
                         ...
                         logger=[pl_loggers.TensorBoardLogger(f'./logs/BIOT/Seed{seed}', name="MoEEG_PhysioP300_tb",
                                                              version=f"subject{sub}"),
                                 pl_loggers.CSVLogger(f'./logs/BIOT/Seed{seed}', name="MoEEG_PhysioP300_csv", version=f"subject{sub}",)])
