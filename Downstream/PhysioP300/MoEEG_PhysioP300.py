...
from utils import *
from Modules.models.MoEEG import *
...
all_subjects = [2, 3, 4, 5, 6, 7, 9, 11, 1]
had_test = []
...
if __name__ == "__main__":
    for i, sub in enumerate(all_subjects):
        ...
        trainer = pl.Trainer(accelerator='cuda',
                         ...
                         logger=[pl_loggers.TensorBoardLogger('./logs/MoEEG/V13/', name="MoEEG_PhysioP300_tb",
                                                              version=f"subject{sub}"),
                                 pl_loggers.CSVLogger('./logs/MoEEG/V13/', name="MoEEG_PhysioP300_csv", version=f"subject{sub}",)])
