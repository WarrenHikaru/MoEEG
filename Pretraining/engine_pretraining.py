...
from MoEEG import EEGTransformer, EEGTransformerPredictor, EEGTransformerReconstructor, apply_mask
from configs import *
...
class LitEEGPT(pl.LightningModule):
    ...
    def validation_step(self, batch, batch_idx):
        ...
        h, y,aux_loss = self.forward_target(x, mask_y)
        z, r,aux_loss = self.forward_context(x, mask_x, mask_y)
